...
//            overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out)
            ...
            btnNext.setOnSingleClickListener { listener.triggerNext(ChartFlowActivity.AnnualRentalIncreases_TYPE) }
            listener.prepareNext(ChartFlowActivity.AnnualRentalIncreases_TYPE)
        }
    }
    ...
    private fun setChartData() {
        (context as ChartFlowActivity).apply {
            ...
            tvAmountYear2.text="${legendsList[0].amount!!.clearFormat().toFloat().plus(legendsList[1].amount!!.clearFormat().toFloat()).toString().clearFormat().addFormatDecimal()}"
            tvAmountYear3.text="${legendsList[0].amount!!.clearFormat().toFloat().plus(legendsList[1].amount!!.clearFormat().toFloat()).toString().clearFormat().addFormatDecimal()}"
            tvAmountYear4.text="${legendsList[0].amount!!.clearFormat().toFloat().plus(legendsList[1].amount!!.clearFormat().toFloat()).toString().clearFormat().addFormatDecimal()}"
            tvAmountYear5.text="${legendsList[0].amount!!.clearFormat().toFloat().plus(legendsList[1].amount!!.clearFormat().toFloat()).toString().clearFormat().addFormatDecimal()}"
