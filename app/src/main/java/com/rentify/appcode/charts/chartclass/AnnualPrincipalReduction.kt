...
class AnnualPrincipalReduction(
    val context: Context,
...
//            overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out)
            ...
            titleHeader.apply {
                ...
                textSize =
                    if (chartFLowModel!!.title!!.length < 20) 20f else if (chartFLowModel!!.title!!.length < 24) 19f else 18f
            }
            ...
            btnNext.setOnSingleClickListener { listener.triggerNext(ChartFlowActivity.AppreciationGrowth_TYPE) }
            listener.prepareNext(ChartFlowActivity.AppreciationGrowth_TYPE)
        }
    }
...
//                total = total.plus(it.amount!!.clearFormat().toFloat())
            ...
            |${legendsList[0].amount!!.clearFormat().addFormatDecimal()}
        """.trimMargin()
