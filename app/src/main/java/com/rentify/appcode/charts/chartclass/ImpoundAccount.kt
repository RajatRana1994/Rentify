...
//            overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out)
            ...
            btnNext.setOnSingleClickListener { listener.triggerNext(ChartFlowActivity.AnnualPrincipalReduction_TYPE) }
            listener.prepareNext(ChartFlowActivity.AnnualPrincipalReduction_TYPE)
        }
    }
