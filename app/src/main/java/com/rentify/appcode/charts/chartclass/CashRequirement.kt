...
//            overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out)
            ...
            btnNext.setOnSingleClickListener { listener.triggerNext(ChartFlowActivity.IntRateOfReturn_TYPE) }
            listener.prepareNext(ChartFlowActivity.IntRateOfReturn_TYPE)
        }
    }
